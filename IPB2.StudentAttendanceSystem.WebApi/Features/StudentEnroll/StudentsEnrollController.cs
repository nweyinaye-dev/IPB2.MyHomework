...
namespace IPB2.StudentAttendanceSystem.WebApi.Features.StudentEnroll
{
    ...
    {
        private readonly IStudentsEnrollService _studentsEnrollService;
        public StudentsEnrollController(IStudentsEnrollService service)
        {
            _studentsEnrollService = service;
        }
